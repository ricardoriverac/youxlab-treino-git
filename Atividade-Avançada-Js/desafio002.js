...
let caro = []
EstoqBarato= 0
EstoqIntermediario = 0
EstoqCaro = 0

for (produto of produtos){ 
    if (produto.preco <= 100){ 
        barato.push(produto) 
        EstoqBarato+=produto.estoque 
    }

    if (produto.preco > 100 && produto.preco <= 1000 ){
        intermediario.push(produto)
        EstoqIntermediario+=produto.estoque
    }

    if(produto.preco > 1000){
        caro.push(produto)
        EstoqCaro+=produto.estoque
    }
...
console.log("Quantidade de produtos: ", EstoqBarato)

console.log("\nProdutos intermediário: ")
for (produto of intermediario){
    console.log("Nome: ", produto.nome, " Categoria: ", produto.categoria, " Preço: ", produto.preco, " Estoque: ", produto.estoque)
}
console.log("Quantidade de produtos: ", EstoqIntermediario)

console.log("\nProdutos caros: ")
for (produto of caro){
    console.log("Nome: ", produto.nome, " Categoria: ", produto.categoria, " Preço: ", produto.preco, " Estoque: ", produto.estoque)
}
console.log("Quantidade de produtos: ", EstoqCaro)