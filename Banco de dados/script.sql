...
-- criando a tabela de  nacionalidade
create table nascionalidade (
idnascionalidade  integer not null, 
nome varchar(30 ) not null,

constraint  pk_ncn_nascionalidade primary key  (idnascionalidade),
