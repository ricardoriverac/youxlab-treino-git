...
for (const produto of produtos) {
  if (produto.preco <= 100) {
    ...
    faixas.Intermediário.push(produto);
  } else {
    faixas.Caro.push(produto);
  }
}

console.log("Barato:", faixas.Barato.length, "produtos");
console.log("Intermediário:", faixas.Intermediário.length, "produtos");
console.log("Caro:", faixas.Caro.length, "produtos");
console.log(faixas);
